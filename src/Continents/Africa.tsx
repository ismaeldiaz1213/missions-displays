...
const Africa: React.FC = () => {
  ...
  const missionaries = getMissionariesByContinent('africa');
  ...
  return (
    <Box sx={{ background: 'linear-gradient(135deg, #FAFBFC 0%, #F0F4F8 100%)', minHeight: '100vh', pb: 4 }}>
      <Box sx={{ background: 'linear-gradient(135deg, #FFFFFF 0%, #F9FAFB 100%)', borderBottom: '4px solid #F44336', p: 3, mb: 3 }}>
        <h1 style={{ color: '#F44336', margin: 0, marginBottom: '0.5rem' }}>🌍 África</h1>
      ...
      <Grid2 container spacing={3} sx={{ px: 3 }}>
        ...
        <Grid2 size={{ xs: 12, md: 4 }}>
          <Paper sx={{ p: 2, background: 'linear-gradient(135deg, #FFFFFF 0%, #F9FAFB 100%)', borderRadius: '12px', position: 'sticky', top: '1rem' }}>
            <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#F44336', mb: 2 }}>📍 Mapa Regional</Typography>
            <LeafletRegionalMap centerLat={AFRICA_LAT_CENTER} centerLong={AFRICA_LON_CENTER} />
